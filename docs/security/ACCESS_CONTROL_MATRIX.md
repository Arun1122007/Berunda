...
[//]: # (Document ID: BERUNDA-SEC-003 | Version: 1.0 | Status: DRAFT | Classification: CONFIDENTIAL | Owner: Berunda Team | Audience: All stakeholders | Source: 01_Enterprise_Blueprint Â§12 + SRS security/privacy reqs | Last Verified: 2026-07-17 | Review: Monthly)
...
| COMPLIANCE | No jurisdiction filter (except restricted fields â€” always visible) | All records visible |
...
See `docs/api-and-contracts/ERROR_AUTHORIZATION_AND_AUDIT_CONTRACTS.md` Section 2.1 for the complete endpoint-to-permission mapping.
