...
[//]: # (Document ID: BERUNDA-ADR-IDX-001 | Status: DRAFT | Classification: INTERNAL)
...
All ADR documents are in `docs/04_ARCHITECTURE/ADR/` with filenames matching the format `ADR-NNN-TITLE.md`.
