...
def get_ai_assistant_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_ai_assistant_repository()


def get_anomaly_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_anomaly_repository()


def get_fairness_repo(request: Request):
    factory = get_repository_factory(request)
...
def get_hotspot_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_hotspot_repository()


def get_ingestion_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_ingestion_repository()


def get_offender_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_offender_repository()


def get_rag_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_rag_repository()


def get_risk_repo(request: Request):
    factory = get_repository_factory(request)
    return factory.get_risk_repository()


def get_socioeconomic_repo(request: Request):
    factory = get_repository_factory(request)
